...
VIAddVersionKey /Lang=0 "ProductVersion" "5.1.0"
...
PageEx License
  ...
  LicenseData "lua-5.1\COPYRIGHT"
PageExEnd

PageEx Directory
  Caption ": Selec installation directory"
  DirText "Select where to isntall Lua 5.1.0 (optional). If you choose a custom directory, please make sure this installer has write permissions."
PageExEnd
...
Section "-Install"
  ...
  ; -----------------
  ; Files to install
  File "lua-5.1\lua51.exe"
  File "lua-5.1\lua51.dll"
  File "icon.ico"
  ...
  ${If} $IsAdmin == True
    ...
    WriteRegStr HKLM "${URegPath}" "DisplayVersion" "5.1.0"
  ...
  ${Else}
    ...
    WriteRegStr HKCU "${URegPath}" "DisplayVersion" "5.1.0"
