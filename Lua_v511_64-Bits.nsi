...
VIAddVersionKey /Lang=0 "ProductVersion" "5.1.1"
...
PageEx Directory
  ...
  DirText "Select where to isntall Lua 5.1.1 (optional). If you choose a custom directory, please make sure this installer has write permissions."
PageExEnd
...
Section "-Install"
  ...
  ${If} $IsAdmin == True
    ...
    WriteRegStr HKLM "${URegPath}" "DisplayVersion" "5.1.1"
  ...
  ${Else}
    ...
    WriteRegStr HKCU "${URegPath}" "DisplayVersion" "5.1.1"
